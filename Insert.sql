...
('5872 8293 3321 0123', '2020-5-14','BMO'),
('4902 9212 3402 8831', '2027-7-01','CIBC'),
('5782 7293 8472 0318', '2028-8-15','CIBC'),
('4509 4462 9302 0716', '2030-1-30','CIBC'),
('8473 9299 8492 7361', '2024-6-20','BMO'),
('4457 4992 7391 0219', '2025-8-30','BMO'),
('5728 8391 7362 5381', '2035-5-20','CIBC'),
('7283 8982 8361 5593', '2029-4-14','BMO'),
('9238 2749 5738 5921', '2027-8-01','CIBC'),
('2839 8219 3728 2933', '2031-5-20','CIBC');
...
(8,'Choby Collection','Quebec','Montreal','No.2012 Sanguinet',4,'2006-5-30'),
(10,'BestBuy','British Columbia','Vancouver','No.20 ShineStreet',5,'2002-8-05'),
(39,'CoolGuy','Quebec','Montreal','No.1023 St-Catherine',3,'2012-2-24'),
(77,'Your Favorite','Ontario','Toronto','No.3022 Saint Denis',4,'2015-7-25'),
(218,'American Eagle','Quebec','Quebec city','No.5 Berri Street',2,'2004-11-17');

insert into brand values
('Asus'),('Bose'), ('Canon') , ('DELL') , ('GoPro') , ('Microsoft');

insert into servicepoint values
...
insert into  save_to_shopping_cart values 
(5,1,'2017-02-21',1),
(5,2,'2016-09-18',1),
(18,3,'2014-03-22',2),
(12,4,'2017-01-23',1),
...
insert into after_sales_service_at values
('Asus',27),
('Microsoft',27),
('DELL',72),
('Microsoft',34),
