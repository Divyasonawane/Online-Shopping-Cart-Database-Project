...
public class SQL {
    ...
    public SQL() throws SQLException {
        ...
        String url = "jdbc:mysql://localhost:3306/myproject"; // Replace with your database name
        try {
            connection = DriverManager.getConnection(url, "root", "divya"); // Replace with your username and password
